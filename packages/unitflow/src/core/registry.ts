...
export interface DebugSink {
	readonly write: (store: { readonly id: string; readonly name?: string }, value: unknown) => () => void
	readonly emit: (event: { readonly id: string; readonly name?: string }, value: unknown) => () => void
