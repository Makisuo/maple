...
import { type DebugSink, type InstanceKey, leaseCount, Registry, type RegistryService } from "../registry.js"
 ...
 * previous sink.
 */
export const attach = (options?: AttachOptions): Effect.Effect<Inspector, never, Registry> =>
...
export const attachTo = (registry: RegistryService, options?: AttachOptions): Inspector => {
	...
	const record = (type: DebugEvent["type"], id: string, name: string, value?: unknown): DebugEvent => {
