...
const MutationTxidFields = {
	txid: Schema.optionalKey(
		Schema.String.annotate({
			description:
				"Internal Postgres transaction identifier used by the Maple dashboard to reconcile ElectricSQL state. API consumers should ignore this field.",
			examples: ["81234"],
		}),
	),
}
