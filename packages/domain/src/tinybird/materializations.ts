 ...
 *
 * No `POPULATE` — the emitter never emits one, and the deploy runbook (§8 of the
 * write-side plan) requires the classifier at 100% for a full clock hour before
 * this view exists, so there is no window to backfill.
 */
