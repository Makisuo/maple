...
describe("ClickHouse migrations", () => {
	it("keeps migrations ordered by version", () => {
		...
		expect(migrations.at(-1)).toBe(migration_0022_service_map_edge_quantiles)
		expect(latestMigrationVersion).toBe(22)
		...
		// tables it touches are MV-populated and the gateway writes neither.
