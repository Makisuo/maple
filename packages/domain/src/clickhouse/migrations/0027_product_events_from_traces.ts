...
/**
 * Backfill of the trace half of {@link migration_0027_product_events_from_traces}.
 *
...
/**
 * Migration 0027 — product events annotated in code.
 *
 ...
 * SELECT is fixed at creation, so the pre-0027 body writes 15 columns into a
 ...
 * 21, so a BYO org that has not applied 0027 is still routed to its own cluster
 ...
 */
export const migration_0027_product_events_from_traces = {
	version: 27,
	description:
