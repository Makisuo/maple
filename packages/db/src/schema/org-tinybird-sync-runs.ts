...
export const orgTinybirdSyncRuns = sqliteTable(
  "org_tinybird_sync_runs",
  {
    ...
    targetLogsRetentionDays: integer("target_logs_retention_days", { mode: "number" }),
    targetTracesRetentionDays: integer("target_traces_retention_days", { mode: "number" }),
    targetMetricsRetentionDays: integer("target_metrics_retention_days", { mode: "number" }),
