...
-- 0003_chubby_bill_hollister.sql
...
-- 0005_crazy_joshua_kane.sql
ALTER TABLE `scrape_targets` ADD `service_name` text;

-- 0006_ancient_frog_thor.sql
...
-- 0007_tense_captain_britain.sql
...
-- 0010_exclude_service_names.sql
ALTER TABLE `alert_rules` ADD `exclude_service_names_json` text;

-- 0011_digest_subscriptions.sql
...
-- 0012_org_tinybird_sync_runs.sql
...
-- 0014_alert_grouping_clean_cut.sql
UPDATE `alert_rules`
...
-- 0015_digest_last_attempted_at.sql
