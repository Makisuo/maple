...
-- spec:traces-list-grouped-duration-sort:baseline  [be86fba9]
SELECT
          TraceId AS traceId,
...
-- spec:traces-list-grouped:baseline  [4cf495a8]
SELECT
          TraceId AS traceId,
          argMin(Timestamp, (if(ParentSpanId = '', 0, 1), Timestamp)) AS startTime,
          fromUnixTimestamp64Nano(max(toUnixTimestamp64Nano(Timestamp) + toInt64(Duration))) AS endTime,
...
-- spec:traces-list-grouped:bloom  [4cf495a8]
SELECT
          TraceId AS traceId,
          argMin(Timestamp, (if(ParentSpanId = '', 0, 1), Timestamp)) AS startTime,
          fromUnixTimestamp64Nano(max(toUnixTimestamp64Nano(Timestamp) + toInt64(Duration))) AS endTime,
...
-- spec:traces-list-grouped:text  [4cf495a8]
SELECT
          TraceId AS traceId,
          argMin(Timestamp, (if(ParentSpanId = '', 0, 1), Timestamp)) AS startTime,
          fromUnixTimestamp64Nano(max(toUnixTimestamp64Nano(Timestamp) + toInt64(Duration))) AS endTime,
