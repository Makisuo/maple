 ...
 *
 * Everything Maple-specific about talking to a model lives here, never inside `packages/llm`
 * (see `packages/llm/MAPLE.md`): the layer wiring, the Workers AI binding shim, model selection
