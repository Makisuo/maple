...
export const bucketCacheBucketsHit = Metric.counter(
  "query_engine.bucket_cache.buckets_hit_total",
  {
    description:
      "Buckets served from the bucket cache without re-querying Tinybird",
    incremental: true,
  },
)

export const bucketCacheBucketsMissed = Metric.counter(
  "query_engine.bucket_cache.buckets_missed_total",
  {
    description:
      "Buckets that were fetched from Tinybird and written to the bucket cache",
    incremental: true,
  },
)
...
export const bucketCacheMissingRanges = Metric.histogram(
  "query_engine.bucket_cache.missing_ranges",
  {
