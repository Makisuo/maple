...
export const renderCollectorConfig = (
  ...
  // When no self-managed orgs exist, every payload falls through to
  // `tinybird/fallback`. Collector still starts cleanly — operators can
  // enable the pool in advance of onboarding the first BYO customer.
