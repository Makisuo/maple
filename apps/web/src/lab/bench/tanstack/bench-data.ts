...
export const OVERVIEW_BENCH_ROWS: readonly OverviewBenchRow[] = makeRows()

/**
 * Recharts' `dataKey` reads and TanStack's channel accessors both need a mutable
 * array; the frozen export above is the identity all arms share.
 */
export const overviewBenchRows = OVERVIEW_BENCH_ROWS as OverviewBenchRow[]
