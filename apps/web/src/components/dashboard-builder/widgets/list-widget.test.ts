...
describe("buildWidgetDataSource for list", () => {
  ...
  it("produces correct data source from list state", async () => {
    ...
    const { parseWhereClause, normalizeKey: normKey, parseBoolean: parseBool } = await import("@maple/query-engine/where-clause")
    ...
    for (const [fn, p] of [
      [serverFunctionMap.list_traces, { ...params1, startTime: "2026-03-28 00:00:00", endTime: "2026-03-28 23:59:59" }],
      [serverFunctionMap.list_traces, { ...params2, startTime: "2026-03-28 00:00:00", endTime: "2026-03-28 23:59:59" }],
      [serverFunctionMap.list_traces, { ...params3, startTime: "2026-03-28 00:00:00", endTime: "2026-03-28 23:59:59" }],
      [serverFunctionMap.list_logs, { ...params4, startTime: "2026-03-28 00:00:00", endTime: "2026-03-28 23:59:59" }],
    ] as const) {
      const result = await Effect.runPromise(
