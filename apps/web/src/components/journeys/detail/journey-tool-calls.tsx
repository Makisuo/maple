...
interface ToolLane {
	readonly call: JourneyEventData
...
export function JourneyToolCalls({ calls }: { calls: ReadonlyArray<JourneyEventData> }) {
...
function buildLanes(calls: ReadonlyArray<JourneyEventData>): {
