      ...
      <DialogContent className="max-w-2xl overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            collector. Pick a platform and run the command below on your target host —
            the new host will appear here within about a minute.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2 min-w-0">
          <Tabs value={platform} onValueChange={(v) => setPlatform(v as Platform)}>
            ...
            <TabsContent value="docker" className="pt-4">
              <p className="text-muted-foreground mb-3 text-xs">
                Runs the contrib collector with hostmetrics, docker stats, and OTLP
                receivers. Requires Docker &ge; 20.10.
              </p>
            </TabsContent>
          ...
          <p className="text-muted-foreground text-xs">
            The token above is your org's <strong className="text-foreground">private
            ingest key</strong>. Rotate it from Settings → Ingestion if it leaks.
          </p>
        </div>
