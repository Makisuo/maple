...
import { CheckIcon, CopyIcon, EyeIcon, CircleCheckIcon, ArrowLeftIcon, ClockIcon } from "@/components/icons"
			...
			<div className="flex-1 flex gap-0 px-6 lg:px-12 py-8 overflow-hidden">
				...
				<div className="w-[340px] shrink-0 flex flex-col gap-8 pr-8">
					...
					<div className="flex items-center gap-2">
						...
						<span className="text-sm font-medium text-muted-foreground">{snippet.label}</span>
					</div>

					{/* Heading */}
					<div className="space-y-2">
						<h2 className="text-3xl font-semibold tracking-tight">Connect your app</h2>
						<p className="text-sm text-muted-foreground leading-relaxed">
							Copy your credentials and add the instrumentation snippet to start sending traces.
						</p>
					</div>
