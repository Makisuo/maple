        ...
        <div className="flex min-w-0 items-start gap-4">
          ...
          <div className="min-w-0 space-y-1.5">
            <div className="flex flex-wrap items-center gap-2">
              <span className="truncate text-sm font-semibold tracking-tight">{destination.name}</span>
              <span
            ...
            <div className="truncate font-mono text-[13px] text-muted-foreground">{destination.summary}</div>

            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-muted-foreground/80">
              <span>
                Last tested{" "}
                <span className="text-foreground/70">
                  {destination.lastTestedAt ? formatRelativeTime(destination.lastTestedAt) : "never"}
                </span>
              </span>
            </div>
