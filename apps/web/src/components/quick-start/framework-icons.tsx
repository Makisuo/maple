...
interface FrameworkIconProps extends SVGProps<SVGSVGElement> {
  size?: number
  className?: string
}

export function NextjsIcon({ size = 24, className, ...props }: FrameworkIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function NodejsIcon({ size = 24, className, ...props }: FrameworkIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PythonIcon({ size = 24, className, ...props }: FrameworkIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GoIcon({ size = 24, className, ...props }: FrameworkIconProps) {
  return (
    <svg
      width={size}
      height={size}
