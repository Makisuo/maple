...
// Source: simple-icons (MIT) — https://simpleicons.org/icons/deno
// Monochrome by design: this is a runtime mark, and the service map renders
// runtime glyphs in the surface's muted text color so the branded platform
// icon beside them stays the node's only color accent.
function DenoIcon({ size = 24, className, ...props }: IconProps) {
	return (
		<svg
