...
// Source: simple-icons (MIT) — https://simpleicons.org/icons/railway
// Railway's mark is monochrome — rendered in currentColor so the catalog can
// theme it via iconClassName (like GitHub/PlanetScale).
function RailwayIcon({ size = 24, className, ...props }: IconProps) {
	return (
		<svg
