...
pub const PROJECT_REVISION: &str = "09c55b9a8ea0014b91c82928e78a4faca1df1d497103eab0431241890b2899fb";
...
pub const DATASOURCES: &[InsertMapping] = &[
    ...
    InsertMapping {
        ...
        columns: &["OrgId", "Timestamp", "Source", "SessionId", "Seq", "VisitorId", "UserId", "GroupId", "Kind", "EventName", "Host", "PagePath", "Url", "ServiceName", "Attributes", "TraceId", "SpanId"],
        selects: &["__ORG__", "timestamp", "source", "session_id", "seq", "visitor_id", "user_id", "group_id", "kind", "event_name", "host", "page_path", "url", "service_name", "attributes", "trace_id", "span_id"],
        input_schema: "timestamp DateTime64(9), source LowCardinality(String), session_id String, seq UInt32, visitor_id String, user_id String, group_id String, kind LowCardinality(String), event_name String, host LowCardinality(String), page_path String, url String, service_name LowCardinality(String), attributes Map(String, String), trace_id String, span_id String",
    },
];
