...
pub const PROJECT_REVISION: &str = "0af05e9acde0fd2db7346a9e2e360eb0fcfa9355ed121ac0282fbe98f6eb2bd2";
...
pub const DATASOURCES: &[InsertMapping] = &[
    InsertMapping {
        ...
        selects: &["__ORG__", "start_time", "trace_id", "span_id", "parent_span_id", "trace_state", "span_name", "span_kind", "service_name", "resource_schema_url", "resource_attributes", "scope_schema_url", "scope_name", "scope_version", "scope_attributes", "duration", "status_code", "status_message", "span_attributes", "events_timestamp", "events_name", "events_attributes", "links_trace_id", "links_span_id", "links_trace_state", "links_attributes", "ai_vendor", "ai_session_key_state", "ai_session_key_hash", "ai_rules_version", "ai_rollup_hour"],
