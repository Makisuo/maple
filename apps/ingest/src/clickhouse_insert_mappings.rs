...
pub const PROJECT_REVISION: &str = "86ad7aeecdcf488576a799833dac86a2e1836f9694e85171593db82d3a113e7b";
...
pub const DATASOURCES: &[InsertMapping] = &[
    InsertMapping {
        ...
        selects: &["__ORG__", "start_time", "trace_id", "span_id", "parent_span_id", "trace_state", "span_name", "span_kind", "service_name", "resource_schema_url", "resource_attributes", "scope_schema_url", "scope_name", "scope_version", "scope_attributes", "duration", "status_code", "status_message", "span_attributes", "events_timestamp", "events_name", "events_attributes", "links_trace_id", "links_span_id", "links_trace_state", "links_attributes", "ai_vendor", "ai_session_key_state", "ai_session_key_hash", "ai_rules_version"],
        input_schema: "start_time DateTime64(9), trace_id String, span_id String, parent_span_id String, trace_state String, span_name LowCardinality(String), span_kind LowCardinality(String), service_name LowCardinality(String), resource_schema_url String, resource_attributes Map(LowCardinality(String), String), scope_schema_url String, scope_name String, scope_version String, scope_attributes Map(LowCardinality(String), String), duration UInt64, status_code LowCardinality(String), status_message String, span_attributes Map(LowCardinality(String), String), events_timestamp Array(DateTime64(9)), events_name Array(LowCardinality(String)), events_attributes Array(Map(LowCardinality(String), String)), links_trace_id Array(String), links_span_id Array(String), links_trace_state Array(String), links_attributes Array(Map(LowCardinality(String), String)), ai_vendor LowCardinality(String), ai_session_key_state UInt8, ai_session_key_hash UInt64, ai_rules_version UInt32",
    },
    InsertMapping {
        datasource: "logs",
        table: "logs",
