/**
 * The marketing site as an alchemy class, yielded by the root stack
 * (`yield* Landing`); its props read `MapleStack`. The entry stays the
 * hand-written `src/worker.ts` (markdown-twin negotiation over the assets).
 */
...
export default class Landing extends Cloudflare.Worker<Landing>()("landing", props) {}
